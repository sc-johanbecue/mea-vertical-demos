...
export type KpmgBeyondArticleCardTileProps = {
...
export function KpmgBeyondArticleCardTile({
  fields,
  id,
  className,
  componentKey,
}: KpmgBeyondArticleCardTileProps): JSX.Element {
  ...
  const ariaLabel =
    ...
    (typeof fields.ArticleTitle?.value === 'string' && fields.ArticleTitle.value) ||
    'Article';
  ...
  return (
    <SitecoreLink
      ...
      field={fields.Link}
      className={[
        'component kpmg-beyond-top-pick-card mb-9 block w-full max-w-[1059px] no-underline last:mb-0',
        className || '',
      ].join(' ')}
      id={id}
