...
export type KpmgBeyondSolutionBannerProps = ComponentProps;

export const Default = (props: KpmgBeyondSolutionBannerProps): JSX.Element => {
  ...
  return (
    <section
      ...
      {...editingHydration}
      id={id}
      data-cy="solution-banner"
      className={['component kpmg-beyond-solution-banner relative w-full', styles || ''].join(' ')}
    >
